...
| *26-08-2026* | *[Nama Anggota 1]* | *Mengumpulkan data pendukung latar belakang: Riskesdas 2018, Profil Kesehatan Indonesia 2024, AKI Long Form SP2020, dan PMK No. 24 Tahun 2022* | *3* | *Done* | *-* | 
| *27-08-2026* | *[Nama Anggota 2]* | *Menyusun Bab 1: latar belakang masalah, keterkaitan dengan target SDG 3.1/3.4/3.8, dan urgensi* | *3,5* | *Done* | *-* | 
| *27-08-2026* | *[Nama Anggota 3]* | *Menyusun Subbab 1.2: analisis alur proses manual saat ini, identifikasi kesenjangan G-01 s.d. G-07, dan perbandingan dengan solusi eksisting* | *3* | *Done* | *-* | 
| *28-08-2026* | *[Nama Anggota 4]* | *Menyusun Bab 2: deskripsi perangkat lunak, justifikasi platform desktop, nilai unik, serta daftar asumsi dan batasan* | *3,5* | *Done* | *-* | 
| *28-08-2026* | *[Nama Anggota 5]* | *Menyusun Subbab 3.1 dan 3.2: identifikasi lima aktor dan penulisan 25 user story* | *3* | *Done* | *-* | 
