...
Perbedaan utama SEHATI dari SIMPUS pada umumnya adalah kemampuannya dalam membandingkan hasil pengukuran pasien antar-waktu, menandai pola-pola yang mengarah ke risiko penyakit tidak menular (hipertensi, obesitas, indikasi diabetes), lalu menyusunnya menjadi daftar pantau yang ditindaklanjuti petugas. Seluruh fungsi berjalan penuh di atas basis data lokal tanpa memerlukan internet (*offline-first*), sementara sinkronisasi ke SATUSEHAT dijalankan secara tunda ketika koneksi internet tersedia, sehingga kewajiban regulasi tetap terpenuhi.
...
| US-08 | Tenaga Klinis | Melihat daftar antrean pasien yang menunggu skrining | Pasien dipanggil sesuai nomor antrean tanpa terlewat, dan petugas dapat melihat siapa yang sedang dilayani   |
...
| US-09b | Tenaga Klinis | Memberikan penandaan risiko hipertensi, obesitas, dan indikasi diabetes pada pasien dengan hasil pengukuran di luar ambang normal | Pasien berisiko langsung teridentifikasi untuk upaya penanganan lanjutan sesuai pedoman |
...
| US-13 | Tenaga Klinis | Mencatat anamnesis, diagnosis, dan tindakan pada kunjungan berjalan | Hasil pemeriksaan tersimpan dalam format terstruktur (anamnesis, diagnosis ICD-10, tindakan) dan dapat diakses oleh petugas berwenang pada kunjungan berikutnya |
...
| US-15 | Tenaga Klinis | Menjadwalkan kunjungan ulang bagi pasien yang perlu dipantau | Pemantauan dan penjadwalan pasien berisiko berlanjut dan muncul pada daftar pantau  |
...
| A06 | Mengevaluasi Ambang Risiko | Sistem SEHATI | Sistem membandingkan nilai yang baru dimasukkan terhadap ambang klinis dan terhadap riwayat pengukuran pasien pada kunjungan sebelumnya | US-09b |
...
| KF14 | R18 | **Ketika** sebuah resep ditandai selesai dilayani dan petugas mengonfirmasi penyerahan, perangkat lunak harus memotong stok setiap obat sesuai jumlah yang diserahkan, menutup kunjungan yang bersangkutan, dan menyusun data kunjungan tersebut menjadi bundel HL7 FHIR pada antrean sinkronisasi |
...
| KF19 | R23 | **Ketika** pengguna memilih rentang tanggal pelaporan, perangkat lunak harus menghitung rekapitulasi kunjungan dan diagnosis terbanyak secara otomatis, lalu menghasilkan berkas laporan dalam dalam format yang dapat dicetak dan diolah secara tabuler (PDF atau Spreadsheet) |
...
| KF23 | R29 | **Ketika** beberapa petugas pada satu jaringan lokal mengubah data yang sama secara bersamaan, perangkat lunak harus memastikan bahwa perubahan bersamaan pada nomor antrean dan pemotongan stok obat tidak saling menimpa dan tidak menyebabkan kehilangan data |
| KF24 | R30 | Perangkat lunak harus menyediakan pintasan papan ketik pada layar pendaftaran, skrining, pemeriksaan, dan apotek untuk bernavigasi, menyimpan formulir, dan memanggil pasien. <br> **Ketika** pintasan tersebut ditekan, perangkat lunak harus mengeksekusi tindakan terkait sehingga seluruh alur pelayanan dapat diselesaikan tanpa tetikus |
...
| KNF04 | R20 | Security | **Ketika** pengguna membuka aplikasi, perangkat lunak harus mewajibkan autentikasi (masuk dengan akun) sebelum fungsi apa pun dapat diakses. <br> Perangkat lunak harus menyimpan kata sandi dalam bentuk *hash* (minimal bcrypt) dan tidak pernah dalam bentuk teks polos. **Jika** pengguna tidak melakukan aktivitas selama 15 menit, maka perangkat lunak harus mengakhiri sesi dan mewajibkan autentikasi ulang|
...
| KNF13 | R28 | Reliablitiy | **Jika** aplikasi mengalami penghentian mendadak, **maka** perangkat lunak harus memastikan bahwa data yang telah disimpan sebelumnya tetap utuh dan konsisten saat aplikasi dimulai kembali |
